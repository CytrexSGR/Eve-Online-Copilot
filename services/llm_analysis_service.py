...
# Cache TTL: 1 hour
# Cache TTL: 1 hour for alliance wars, 7 hours for strategic briefing (regenerated every 6h by cron)
ANALYSIS_CACHE_TTL = 3600
STRATEGIC_BRIEFING_CACHE_TTL = 7 * 3600  # 7 hours (buffer for 6h cron)
